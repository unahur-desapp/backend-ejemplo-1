...
import { fetchTodosLosProductos } from '../repository/productos.repository';
...
export const getTodosLosProductosConUltimaCompra = async (req, res) => {
  const productsDB = await fetchTodosLosProductos(true);
...
export const getTodosLosProductosConCompras = async (req, res) => {
  const products = await fetchTodosLosProductos(true);
...
export const getTodosLosProductosSinCompras = async (req, res) => {
  const products = await fetchTodosLosProductos(false);
